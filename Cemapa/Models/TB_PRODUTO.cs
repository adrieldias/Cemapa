...
namespace Cemapa.Models
{
    ...
    public partial class TB_PRODUTO
    {
        ...
        public Nullable<short> NUM_TRIB_TRANSFERENCIA { get; set; }
        ...
        public Nullable<short> NUM_CX_PALETE { get; set; }
        ...
        public Nullable<short> NUM_DIAS_VALIDADE { get; set; }
        ...
        public Nullable<short> COD_NATUREZA_RECEITA { get; set; }
        ...
        public string DESC_COD_BENEFICIO_FISCAL { get; set; }
        public string COD_BENEF_FISCAL_REDUCAO { get; set; }
        public string COD_BENEF_FISCAL_ISENCAO { get; set; }
        public string COD_BENEF_FISCAL_IMUNIDADE { get; set; }
        public string COD_BENEF_FISCAL_SUSPENSAO { get; set; }
        public string COD_BENEF_FISCAL_DIFERIMENTO { get; set; }
